...
<div class="container-fluid">
                ...
                <div class="card shadow mb-4" style="height: 20rem;">
                    <div class="dropdown no-arrow dropright text-right m-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                            ...
                            <a class="dropdown-item" href="#"><i class="fas fa-eye fa-sm fa-fw text-gray-400 mr-2"></i>View</a>
                            <?php if($user['role_id'] == 1):?>
    ...
    <?php else: ?>
        <div class="row text-center m-5">
            <div class="col-lg">
                <p class="h5 font-weight-bold text-gray-400"> Dokumen tidak tersedia </p>
            </div>
        </div>
    <?php endif; ?>
